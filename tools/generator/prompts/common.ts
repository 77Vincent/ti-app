...
- for language subject, every explanation in o must be exactly an empty string.
- for non-language subjects, explanations in o should be clear and consistent with correctness.
- for non-language subjects, the option explanation should clearly and concise explain the reason.
